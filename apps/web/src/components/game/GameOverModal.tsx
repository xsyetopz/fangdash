...
export function GameOverModal({
  ...
  return (
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      ...
      <div
        className="relative w-full max-w-sm mx-3 sm:mx-4 rounded-lg overflow-hidden max-h-[90dvh] overflow-y-auto"
        style={{
      ...
      >
        ...
        <div className="px-4 sm:px-6 pt-6 sm:pt-8 pb-4 sm:pb-6">
          ...
          <div className="text-center mb-4 sm:mb-6">
            <h2
              className="text-4xl sm:text-5xl font-black font-mono uppercase tracking-tight leading-none mb-2"
              style={{
                color: "#ff6b2b",
                textShadow:
          ...
          {submitResult?.levelUp && submitResult.newLevel && (
            <div
              className="mb-3 sm:mb-4 rounded-lg px-4 py-3 text-center"
              style={{
          ...
          {/* Stats — 2×2 grid */}
          <div className="mb-4 sm:mb-6 grid grid-cols-2 gap-px bg-[#0FACED]/10 rounded overflow-hidden">
            {/* FINAL SCORE */}
            <div className="bg-[#091533] px-3 sm:px-4 py-2.5 sm:py-3">
              <p className="text-[10px] font-mono uppercase tracking-widest text-white/40 mb-1">
                Final Score
              </p>
              <span
                className="text-xl sm:text-2xl font-bold font-mono tabular-nums text-[#0FACED]"
            ...
            <div className="bg-[#091533] px-3 sm:px-4 py-2.5 sm:py-3">
              ...
              <span className="text-xl sm:text-2xl font-bold font-mono tabular-nums text-white/80">
          ...
          {isSignedIn && !cheatsUsed && submitting && (
            <p className="mb-3 sm:mb-4 text-sm text-center font-mono text-white/40">
              Saving score...
            </p>
          )}
          ...
          {submitResult?.achievementError && (
            <p className="mb-3 sm:mb-4 text-xs text-center font-mono text-yellow-400/60">
