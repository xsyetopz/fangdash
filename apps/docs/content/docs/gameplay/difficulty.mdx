...
<Callout type="info">
**TL;DR**
- 5 difficulty tiers triggered by distance milestones
- Speed scales from 300 px/s (Easy) up to 800 px/s (Nightmare)
- Obstacles also spawn more frequently at higher tiers
</Callout>
