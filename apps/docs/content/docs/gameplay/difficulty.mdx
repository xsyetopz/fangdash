...
Your scores are saved with the **difficulty level** you reached. The [leaderboard](/docs/gameplay/leaderboard) lets you filter by difficulty, so you can compare your Nightmare runs against other Nightmare runs.
