...
<Callout type="info">
**TL;DR**
- Race up to 4 players in real-time via WebSocket-powered rooms
- All players face the exact same obstacles (seeded PRNG)
- Ghost players are visible during the race — you can see their live position
</Callout>
